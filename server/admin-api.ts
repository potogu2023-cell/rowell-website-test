...
export const adminRouter = router({
  ...
  addVerifiedCapsAndSeptaCandidates: publicProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const expected = [
        {
          ...
          name: 'Red, 12 x 32 mm Screw Neck Cap and Preslit PTFE/Silicone Septum, 100/pk',
          description: 'Waters part 186002128 is a red 12 x 32 mm screw-neck cap with a preslit PTFE/silicone septum, supplied as 100 caps and septa per pack.',
          detailedDescription: 'Waters lists part 186002128 as a red 12 x 32 mm screw neck cap and preslit PTFE/silicone septum, 100/pk. The official product page identifies screw-neck closure, red cap color, 12 x 32 mm dimensions, a preslit PTFE/silicone seal, cap-and-septum contents, and a 100-pack configuration.',
          specifications: { Manufacturer: 'Waters', 'Manufacturer Part Number': '186002128', 'Closure Type': 'Screw Neck', 'Cap Color': 'Red', Dimensions: '12 x 32 mm', 'Seal Material': 'preslit PTFE/Silicone', Includes: 'Cap & Septum', 'Units per Package': '100 pk' },
          imageUrl: 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663031980410/ptiVtZGZQvyMivpR.png',
          catalogUrl: 'https://www.waters.com/nextgen/us/en/shop/vials-containers--collection-plates/186002128-red-12-x-32-mm-screw-neck-cap-and-preslit-ptfe-silicone-septum-1.html',
          productType: 'Vial Cap and Septum', slug: 'waters-186002128', category: 'Caps & Septa', categoryId: 20,
          metaTitle: 'Waters 186002128 | Caps & Septa | ROWELL',
          metaDescription: 'Waters 186002128: red 12 x 32 mm screw-neck cap with preslit PTFE/silicone septum, 100/pk. Review specifications and request a quote from ROWELL.',
        },
        {
          productId: 'WATERS-186002129', partNumber: '186002129', brand: 'Waters', prefix: 'WATERS',
          name: 'Red, 12 x 32 mm Screw Neck Cap and PTFE/Silicone Septum, 100/pk',
          description: 'Waters part 186002129 is a red 12 x 32 mm screw-neck cap with a PTFE/silicone septum, supplied as 100 caps and septa per pack.',
          detailedDescription: 'Waters lists part 186002129 as a red 12 x 32 mm screw neck cap and PTFE/silicone septum, 100/pk. The official product page identifies screw-neck closure, red cap color, 12 x 32 mm dimensions, a PTFE/silicone seal, cap-and-septum contents, and a 100-pack configuration.',
          specifications: { Manufacturer: 'Waters', 'Manufacturer Part Number': '186002129', 'Closure Type': 'Screw Neck', 'Cap Color': 'Red', Dimensions: '12 x 32 mm', 'Seal Material': 'PTFE/Silicone', Includes: 'Cap & Septum', 'Units per Package': '100 pk' },
          imageUrl: 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663031980410/syAJKWQBUpmHWdEk.png',
          catalogUrl: 'https://www.waters.com/nextgen/us/en/shop/vials-containers--collection-plates/186002129-red-12-x-32-mm-screw-neck-cap-and-ptfe-silicone-septum-100-pk.html',
          productType: 'Vial Cap and Septum', slug: 'waters-186002129', category: 'Caps & Septa', categoryId: 20,
          metaTitle: 'Waters 186002129 | Caps & Septa | ROWELL',
          metaDescription: 'Waters 186002129: red 12 x 32 mm screw-neck cap with PTFE/silicone septum, 100/pk. Review specifications and request a quote from ROWELL.',
        },
        {
          productId: 'AGILENT-5190-7021', partNumber: '5190-7021', brand: 'Agilent', prefix: 'AGILENT',
          name: 'Screw Cap, Bonded Blue PTFE/Silicone Septa, 100/pk',
          description: 'Agilent part 5190-7021 is a blue polypropylene screw cap with bonded PTFE/silicone septa for chromatography vials, supplied as 100 per pack.',
          detailedDescription: 'Agilent lists part 5190-7021 as a screw cap with bonded blue PTFE/silicone septa, 100/pk. The official product page identifies blue polypropylene cap material, 12 mm cap size, 9-425 thread size, a white PTFE/white silicone bi-layer septum, compatibility with GC and LC workflows, and 100-pack packaging.',
          specifications: { Manufacturer: 'Agilent', 'Manufacturer Part Number': '5190-7021', 'Cap Color': 'Blue', 'Cap Material': 'Polypropylene', 'Cap Size': '12 mm', 'Thread Size': '9-425', 'Septa Material': 'PTFE/Silicone', 'Septa Layering': 'Bi-Layer', 'Product Type': 'Caps & septa', Technique: 'GC; LC', 'Units per Package': '100 pack' },
          imageUrl: 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663031980410/emtEsiYxDfVxfQZm.png',
          catalogUrl: 'https://www.agilent.com/store/en_US/Prod-5190-7021/5190-7021',
          productType: 'Vial Cap and Septum', slug: 'agilent-5190-7021', category: 'Caps & Septa', categoryId: 20,
          metaTitle: 'Agilent 5190-7021 | Caps & Septa | ROWELL',
          metaDescription: 'Agilent 5190-7021: blue screw cap with bonded PTFE/silicone septa for GC and LC, 100/pk. Review specifications and request a quote from ROWELL.',
        },
        {
          productId: 'RESTEK-24485', partNumber: '24485', brand: 'Restek', prefix: 'RESTEK',
          name: 'Short Screw Caps, Polypropylene, Screw-Thread, PTFE/Silicone Septa, Blue, Preassembled, 2.0 mL, 9 mm, 100-pk',
          description: 'Restek part 24485 is a blue preassembled 9 mm polypropylene screw-thread cap with PTFE/silicone septum for 2.0 mL vials, supplied as 100 per pack.',
          detailedDescription: 'Restek lists catalog number 24485 as short blue polypropylene screw caps with preassembled PTFE/silicone septa for 2.0 mL, 9 mm vials, 100-pk. The official product page identifies 9-425 cap size, polypropylene material, PTFE/silicone septa, screw-thread type, and 100-pack configuration.',
          specifications: { Manufacturer: 'Restek', 'Manufacturer Part Number': '24485', 'Cap Color': 'Blue', 'Cap Size': '9-425', Material: 'Polypropylene', 'Septa Material': 'PTFE/Silicone', Type: 'Screw-Thread', 'Vial Compatibility': '2.0 mL, 9 mm', 'Units per Package': '100-pk' },
          imageUrl: 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663031980410/WlPnQwzbMJORYPnC.png',
          catalogUrl: 'https://www.restek.com/p/24485',
          productType: 'Vial Cap and Septum', slug: 'restek-24485', category: 'Caps & Septa', categoryId: 20,
          metaTitle: 'Restek 24485 | Caps & Septa | ROWELL',
      ...
      try {
        await connection.beginTransaction();
        const [categoryRows] = await connection.execute('SELECT id, name FROM categories WHERE id = ? LIMIT 1', [20]) as any;
        if (!categoryRows[0] || categoryRows[0].name !== 'Caps & Septa') throw new Error('category precondition failed');
        for (const product of expected) {
          const [existingRows] = await connection.execute(
            'SELECT id FROM products WHERE productId = ? OR (partNumber = ? AND brand = ?) LIMIT 1',
            [product.productId, product.partNumber, product.brand],
          ) as any;
