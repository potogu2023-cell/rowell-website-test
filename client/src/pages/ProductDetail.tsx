                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {hasCatalogValue(product.columnLength) && (
                      <div className="flex justify-between p-3 bg-gray-50 rounded">
                        <span className="text-muted-foreground">{isCartridgeVolume ? 'Cartridge volume' : isGcCapillary ? 'GC capillary length' : isGcLiner ? 'Liner length' : t('productDetail.column_length')}:</span>
